...
<html lang="en" dir="ltr">
	<head>
		...
		<meta charset="utf-8">
		<title> Compare | Look Before You Buy </title>
	...
	<body>
		...
		<div class="col-md-8" style="margin:auto">
			<p class="h3 display-4 text-primary"> Select Models To Compare: </p>

			<form action="getComparison.php" method="post">
				<div class="row" style="padding-top:15px;margin:auto;" >
					<div class="col-md-6">
						<p class="h4"> Product One: </p>
					...
					<div class="col-md-6">
						<p class="h4"> Product Two: </p>
						<select class="custom-select" name="phone_id_1">
						<?php
						try{
							$conn = new PDO('mysql:host=127.0.0.1;dbname=php_lookbeforeyoubuy','root','');
							echo "Connection is established...<br/>";
