...
<html lang="en" dir="ltr">
	...
	<body>
		...
		<center>
		<h1 class="display-4 text-danger"> Deleting Phone Information </h1>
		<br><form action="confirmdelete.php" method="post">
			Phone ID:  <input type="text" name="phone_id">
			<input type="submit" name="submit1" class="btn btn-danger" value="Delete Permanently">
		</form>
		</center>
